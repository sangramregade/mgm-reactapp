...
const EditPatient = () => {
    ...
    const loadPatient = async () => {
        const result = await axios.get(`http://localhost:3003/patients/${id}`);
    ...
    const onSubmit = async e => {
        ...
        let response = await axios.put(`http://localhost:3003/patients/${id}`, formData)
                                            ...
                                            <div className="col-6">
                                                ...
                                                <div class="row">
                                                    <div className="col-4 pt-2">
                                                        <span className="input-group-text text-center">Selected Site</span>
                                                    </div>
                                                    ...
                                                    <div className="card-body mt-3 text-center">
                                                        <div className="form-check form-check-inline" style={{ paddingRight: "50px" }} >
                                                            <input className="form-check-input " type="checkbox"
                                                                checked={formData.symptomp_Headache}
                                                        ...
                                                        <div className="form-check form-check-inline" style={{ paddingRight: "50px" }}>
                                                            <input className="form-check-input" type="checkbox"
                                                                checked={formData.symptomp_Fatigue}
                                                        ...
                                                        <div className="form-check form-check-inline" style={{ paddingRight: "50px" }}>
                                                            <input className="form-check-input" type="checkbox"
                                                                checked={formData.symptomp_Cough}
                                                        ...
                                                        <div className="form-check form-check-inline" style={{ paddingRight: "50px" }}>
                                                            <input className="form-check-input" type="checkbox"
                                                                checked={formData.symptomp_Chest_Pain}
                                                        ...
                                                        <div className="form-check form-check-inline" style={{ paddingRight: "50px" }}>
                                                            <input className="form-check-input" type="checkbox"
                                                                checked={formData.symptomp_Loss_of_Smell_Taste}
                                                                value="Loss of Smell Taste" onChange={(e) => setFormData({ ...formData, symptomp_Loss_of_Smell_Taste: e.target.value })} id="inlineCheckbox5" />
                                                            <label className="form-check-label" htmlFor="inlineCheckbox5">Loss of Smell and Taste</label>
                                                        </div>
                                                        <div className="form-check form-check-inline">
                                                            <input className="form-check-input" type="checkbox"
                                                                checked={formData.symptomp_Shortness_in_breathing}
